...
int main(void)
{
	...
	std::cout << "Total sum of multiples of 3 " << sum_of(multiples_of_3) << std::endl;
	std::cout << "Total sum of multiples of 5 " << sum_of(multiples_of_5) << std::endl;
	std::cout << "Total sum of multiples of 3 or 5 " << sum_of(multiples_of_3_and_5) << std::endl;
